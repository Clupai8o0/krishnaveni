  ...
  return (
		<div className="relative bg-black overflow-hidden">
			<img
				...
				className="absolute object-cover w-full h-auto opacity-20"
			/>

			<Bounded className="items-center">
				<div className="text-white flex flex-col items-center justify-center h-[70vh] max-w-2xl">
					<h1 className='text-5xl font-black mb-4 text-center'>Ready to Shape Your Child’s Future with Krishnaveni?</h1>
					<p className="text-center opacity-80 text-balance mb-8">
						Give your child the best start to their academic journey with a
						nurturing environment, top-tier CBSE curriculum, and holistic
