  ...
  return (
		<BentoGrid
			...
			content1={{
				...
				description:
					"Krishnaveni CBSE School recently organized its much-anticipated Annual Science Fair 2025, where students from grades 3 to 10 showcased their innovative projects and experiments.",
			...
			content2={{
				...
				description:
					"The school’s Annual Sports Day 2025 was a thrilling event filled with energy, enthusiasm, and competitive spirit.",
