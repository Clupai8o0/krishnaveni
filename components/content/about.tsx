			...
			col2={
				<div>
					<h2 className="font-black text-4xl text-balance mb-6">
						...
						<span className="text-yellow-500 underline underline-offset-8 decoration-wavy">
							Brighter Tomorrow
						</span>
					</h2>
					<p className="text-balance opacity-80">
						At Krishnaveni TS SSC/CBSE School, we are committed to nurturing
						young learners through a well-rounded education that blends academic
