...
function TwoColumnsTight({ col1, col2, className }: Props) {
	return (
		<Bounded className="items-center pb-10 px">
			<div
				className={cn(
					"max-w-6xl flex flex-col md:flex-row items-center border rounded-4xl border-gray-300 shadow-[6px_6px_0_0_black] relative overflow-hidden p-8",
					className
				)}
			>
